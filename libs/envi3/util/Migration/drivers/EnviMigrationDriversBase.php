...
abstract class EnviMigrationDriversBase
{
    ...
    abstract public function addColumn($table_name, $column_name, $type, $options = array());
    abstract public function addIndex($table_name, $column_name, $options = array());
    abstract public function addTimestamps($table_name);
    abstract public function changeColumn($table_name, $column_name, $type, $options = array());
    abstract public function changeColumnDefault($table_name, $column_name, $default_val);
    abstract public function createTable($table_name, $options = array());
    abstract public function dropTable($table_name, $options = array());
    abstract public function removeColumn($table_name, $column_names);
    abstract public function removeIndex($table_name, $options = array());
    ...
    // abstract public function changeTable($table_name, $options = array());
}